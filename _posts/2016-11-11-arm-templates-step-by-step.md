...
categories: DevOps
excerpt: "In this article, I’ll explain in detail how to use PowerShell and ARM templates to build out a Linux VM and the associated components such as networking and security."
---
...
![Automation Script Blade in Azure Portal]({{ site.url }}/assets/images/arm-templates-step-by-step-1.png)

Doing this will generate a set of files you can use to recreate the contents of the resource group.

![Generated Template]({{ site.url }}/assets/images/arm-templates-step-by-step-2.png)
...
`PS C:\source\Basic_Azure_VM_ARM_Template> .\deploy.ps1 -subscriptionId f061aa2a-50c2-46a0-818b-6a5829ff5a70 -resourceGroupName mygroup`

From a command prompt, you will need to invoke PowerShell like so:

`C:\source\Basic_Azure_VM_ARM_Template>powershell -f deploy.ps1 -subscriptionId f061aa2a-50c2-46a0-818b-6a5829ff5a70 -resourceGroupName mygroup`
...
```
C:\source\Basic_Azure_VM_ARM_Template>powershell -f deploy.ps1 -subscriptionId cd82f777-1ae3-48fb-8887-05e9f88e3a33 -resourceGroupName mygroup
Logging in...
